...
const Error404 = () => {
  ...
  return (
    <div className='lg:px-24 lg:py-24 md:py-20 md:px-44 px-4 py-32 items-center flex justify-center items-center flex-col-reverse lg:flex-row md:gap-28 gap-16'>
