...
const dataReducer = (labelState: ILabels[], action: labelAction): ILabels[] => {
  switch (action.type) {
    ...
    case 'UPDATE_LABEL':
      ...
      // const colorBg = action.payload.data.colorBg;
      // const colorIcon = action.payload.data.colorIcon;
      // const colorBgStrip = action.payload.data.colorBgStrip;
