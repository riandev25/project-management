const UserNavigation = () => {
  return (
    ...
    <div className='min-w-fit flex-0 min-w-screen px-6 py-4 overflow-y-auto rounded dark:bg-gray-800'>
      <ul className='w-64 space-y-3'>
        <li>
          <a
            href='#'
            className='flex items-center p-1.5 text-sm font-bold bg-gray-200 text-gray-800 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700'
          >
            <svg
              aria-hidden='true'
        ...
        <li>
          <a
            href='#'
            className='flex items-center p-1 text-sm font-bold bg-gray-200 text-gray-800 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700'
          >
            <svg
              aria-hidden='true'
              className='w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white'
