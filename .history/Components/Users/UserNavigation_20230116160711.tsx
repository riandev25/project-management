const UserNavigation = () => {
  return (
    <aside className='w-64' aria-label='Sidebar'>
      <div className='px-3 py-4 overflow-y-auto rounded bg-green-300 dark:bg-gray-800'>
        <ul className='space-y-2'>
          <li>
            <a
              href='#'
              className='flex items-center p-2 text-sm font-semibold text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'
            >
              <svg
                aria-hidden='true'
