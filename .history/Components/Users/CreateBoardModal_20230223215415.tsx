...
const CreateBoardModal = () => {
  ...
  return (
    <form
      // ref={ref}
      className='z-30 sfixed top-1/2 sm:top-60 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col w-72 shadow-md rounded-sm bg-white px-3 py-2 gap-3'
