...
const AuthMainComponent = () => {
  ...
  return (
    // <div className='flex flex-row justify-center items-center w-full h-screen  bg-[url("/images/auth-img.png")] bg-cover'>
          ...
          >
            <div className='flex flex-col space-y-1'>
              ...
              <input
                ...
                required
              />
              {errors.email ? <p>{emailError}</p> : null}
            </div>
            <div className='flex flex-col space-y-1'>
              ...
              <input
                ...
                required
              />
              {errors.password ? <p>{passwordError}</p> : null}
            </div>
