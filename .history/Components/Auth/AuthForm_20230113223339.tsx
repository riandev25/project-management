...
import { useAuthRequest } from '../../lib/hooks/auth/useAuthRequest';
...
const AuthForm = () => {
  ...
  return (
    ...
    >
      ...
      {path === 'login' ? (
        <AuthSubmitBtn btnName='Login' />
      ) : (
        <AuthSubmitBtn btnName='Register' />
      )}
      {path === 'login' ? (
