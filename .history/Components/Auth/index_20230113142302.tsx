...
const AuthMainComponent = () => {
  ...
  const onSubmitHandler = (data: FieldValues, e: any) => {
    ...
    setPostResult(formatResponse(postData));
    reset();
  };
        ...
        <section className='p-5 bg-white md:flex-1'>
          ...
          >
            ...
            <div className='relative flex flex-col space-y-1'>
              ...
              {/* <button
                type='button'
                className='absolute bottom-2 right-2 text-gray-500 transition-colors duration-300 hover:text-gray-800 focus:outline-none focus:ring-blue-200 focus:ring-4'
