...
const CardOptions = ({ _id, actions, pos, exitHandler }: CardOptionProp) => {
  ...
  return (
    <div
      className={`${pos} z-20 -top-2 -left-2 absolute w-[17rem] rounded-sm bg-transparent text-gray-600`}
    >
      <div>
        <form
        ...
        >
          <textarea
            ...
            role='textbox'
            className='h-28 py-2.5 px-2 bg-white'
          ></textarea>
        ...
        <section className='absolute top-0 -right-24 translate-x-2 bg-transparent'>
          {actions.map((item, i) => {
            return (
              <CardOptionsButton
                key={i}
