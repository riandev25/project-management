...
const CardChild = ({ cardName, _id: idCard, idList }: IBoardCardData) => {
  // const ACTIONS = [
  //   'Add card...',
  //   'Copy list...',
  //   'Move list...',
  ...
  const { mutateAsync: mutateUpdateList, isSuccess: isUpdateSuccess } =
    useUpdateAddList();
  ...
  //     console.log('done');
  //   }
  // }, [isUpdateSuccess, queryClient, refetch]);
