...
const CardOptions = ({
  ...
  return (
    <div
      ref={ref}
      className={`${pos} z-20 -top-2 -left-2 absolute w-[calc(100vw-64px)] xs:w-[260px] rounded-sm bg-transparent text-gray-600`}
    >
      <div className='flex flex-col-reverse gap-2 xs:gap-0 xs:flex-row'>
        <form
          className='flex flex-col w-full xs:w-auto gap-2 text-gray-500'
