...
const CardChild = ({ cardName, idCard }: IBoardCardData) => {
  ...
  const openFeatureModal = (
    ...
    const _id = String(event.currentTarget.dataset.idCard);
    console.log(_id);
    toggleModal(_id);
    setLocalStorage('idCard', idCard);
  };
    ...
    <Fragment>
      ...
      {filteredModal?.isOpen && (
        <Portal portalId='#myportal'>
          <CardFeaturesModal idCard={idCard} />
        </Portal>
      )}
