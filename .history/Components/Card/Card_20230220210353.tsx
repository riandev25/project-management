...
const Card = ({ cards, listName, _id }: IBoardData) => {
  ...
  return (
    <div className='relative flex flex-col flex-1 w-[calc(100vw-32px)] xs:w-[17rem] bg-gray-300 px-1.5 pb-2 rounded-sm text-sm text-gray-700'>
      ...
      {isOptionOpen && (
        ...
        <ListOptions
          _id={_id}
          actions={ACTIONS}
          pos='right-0 xs:translate-x-[14.5rem] translate-y-8'
          exitHandler={toggleCardOption}
        />
      )}
    </div>
