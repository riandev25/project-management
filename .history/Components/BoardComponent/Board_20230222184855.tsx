...
const BoardComponent = () => {
  ...
  return (
    <div className='relative flex flex-col px-2 sm:px-3 gap-4 sm:gap-3 min-h-screen max-w-screen bg-gray-800'>
      <BoardHeader />
      <DragDropContext onDragEnd={handleDragEnd}>
        <ul className='flex flex-row items-start gap-4 overflow-x-auto flex-1 w-full h-full snap-x'>
