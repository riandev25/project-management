...
const BoardComponent = () => {
  ...
  return (
    <div className='flex flex-col px-6 sm:px-0 gap-5 sm:gap-3 min-h-screen'>
      <BoardHeader />
      <ul className='flex flex-col sm:flex-row items-start gap-5 sm:gap-4 sm:overflow-x-auto flex-1 w-full'>
