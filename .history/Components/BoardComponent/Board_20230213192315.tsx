...
const BoardComponent = () => {
  ...
  return (
    <div className='relative flex flex-col px-6 sm:px-0 gap-4 sm:gap-3 min-h-screen'>
      <BoardHeader />
      <ul className='flex flex-col sm:flex-row items-start gap-4 sm:overflow-x-auto flex-1 w-full'>
      ...
      {isOneCardOptionOpen ? (
        <div
          className='absolute z-10 top-0 left-0 min-w-screen min-h-screen'
          style={{
