      ...
      <div className='flex flex-row gap-6'>
        ...
        <section className='fixed bg-white min-h-screen sm:h-auto sm:bg-transparent shadow-2xl sm:shadow-none top-0 left-0 sm:relative flex flex-col gap-4 w-44'>
          <div className='relative min-h-screen sm:h-auto p-4 sm:p-0'>
            ...
            <button className='absolute rounded-full bg-white'>
              <div className='h-2 w-full bg-indigo-500 rounded-t-full'></div>
              <div className='h-8 w-full rounded-full bg-indigo-200'></div>
              <div className='h-2 w-full bg-indigo-500 rounded-b-full'></div>
            </button>
          </div>
        </section>
        <button
