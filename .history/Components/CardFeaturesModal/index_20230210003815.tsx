  ...
  return (
    ...
    >
      ...
      <div className='flex flex-row gap-6'>
        ...
        <section className='-translate-x-full sm:translate-x-0 fixed bg-white min-h-screen sm:h-auto sm:bg-transparent shadow-2xl sm:shadow-none top-0 left-0 sm:relative flex flex-col gap-4 w-44'>
