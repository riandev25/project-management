...
const Features = () => {
  ...
  return (
    <Fragment>
      <div id='Label' classNameName='relative grid grid-cols-1 gap-2'>
        <h3 classNameName='text-xs font-semibold'>Add to card</h3>
      ...
      <div classNameName='grid grid-cols-1 gap-2'>
        <h3 classNameName='text-xs font-semibold'>Action</h3>
        <ul classNameName='space-y-2'>
