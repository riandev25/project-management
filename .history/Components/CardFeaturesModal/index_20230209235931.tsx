      ...
      <div className='flex flex-row gap-6'>
        ...
        <section className='fixed bg-white min-h-screen sm:h-auto sm:bg-transparent shadow-2xl sm:shadow-none top-0 left-0 sm:relative flex flex-col gap-4 w-44'>
          <div className='relative min-h-screen sm:h-auto p-4 sm:p-0'>
            ...
            {/* <button
              type='button'
              className='absolute top-1/2 right-0 translate-x-full w-10 h-10 rounded-r-full bg-red-400'
            >
              a
            </button> */}
            <div className='absolute top-1/2 right-0 translate-x-full'>
              <button className='relative flex items-center justify-center w-12 h-12 bg-white text-black text-center text-2xl font-bold py-1 px-3 shadow-md'>
                <p>a</p>
                <span className='absolute left-0 top-0 w-2 h-full bg-white border-r-2 border-gray-400'></span>
                <span className='absolute bottom-0 left-0 w-2 h-full bg-white border-r-2 border-gray-400'></span>
              </button>
            </div>
          </div>
        </section>
