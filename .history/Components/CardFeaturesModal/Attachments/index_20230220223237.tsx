...
const Attachment = () => {
  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      >
        <input
          className='block w-full text-sm xs:text-base text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400'
          id='file_input'
          type='file'
          {...register('image')}
        />
        ...
        <section className='flex flex-row gap-2 items-center'>
          <button
            ...
            className={`bg-gray-200 w-fit flex flex-row justify-start items-center rounded-sm py-1 px-3 gap-2 text-base text-gray-700 cursor-pointer ${
          ...
          {fileError ? (
            <p className='flex flex-1 text-sm text-red-500'>
