...
const ChecklistModal = () => {
  ...
  return (
    <form
      className='z-20 absolute top-2 sm:-translate-x-28 lg:translate-x-0 flex flex-col w-[calc(100vw-32px)] xs:w-72 shadow-md rounded-sm bg-white px-3 py-2 gap-3'
      onSubmit={onSubmit}
    >
      <HeaderModal
        title='Checklist'
