...
const ChecklistModal = () => {
  ...
  const {
    mutateAsync: mutateCreateChecklist,
  ...
  const onSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    mutateCreateChecklist(capitalizeFirstLetter(checklist));
    setChecklist('');
  };

  useEffect(() => {
    if (isCreateSuccess) toggleFeatureModal();
  }, [isCreateSuccess, toggleFeatureModal]);
