...
const Checklist = ({
  ...
  // const { isChecklistItem1Open, isChecklistItem2Open, isChecklistItem3Open } =
  //   useFeatureState();
  ...
  const openOptionsHandler = (event: React.MouseEvent<HTMLButtonElement>) => {
    // dispatchChecklist({
    //   type: 'TOGGLE_OPTION',
    //   payload: {
    //     idCheckArray: id,
    ...
    console.log(event.currentTarget.dataset.idBtn);
  };
          ...
          {checklistItems.map((item, i) => {
            return (
              ...
              >
                ...
                <ChecklistOptions
                  idCheck={i}
                  openOptionsHandler={openOptionsHandler}
                />
