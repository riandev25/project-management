...
const LabelsModal = () => {
  ...
  const { data: labelData } = useGetLabels();
  ...
  if (!labelData) return <p></p>;

  return (
    <div className='z-20 absolute flex flex-col sm:-translate-x-28 lg:translate-x-0 w-[calc(100vw-32px)] xs:w-72 shadow-md rounded-sm bg-white px-3 py-2 gap-3'>
      <HeaderModal
        title='Labels'
        id='labels-option'
