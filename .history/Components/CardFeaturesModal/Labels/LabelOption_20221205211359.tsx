  ...
  return (
    <div className='z-20 absolute flex flex-col w-72 shadow-md rounded-sm bg-white px-3 py-2 gap-3'>
      ...
      <section className='flex flex-row justify-between'>
        <button
          type='button'
          className='flex justify-center items-center bg-blue-600 w-16 py-1 text-sm text-white'
          onClick={updateLabel}
        >
          Save
        </button>
        <button
          type='button'
          className='flex justify-center items-center bg-red-600 w-16 py-1 text-sm text-white'
        >
          Delete
        </button>
      </section>
