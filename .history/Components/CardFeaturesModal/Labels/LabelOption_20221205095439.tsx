              ...
              <li key={item.id}>
                <button
                  ...
                  className={`${item.bgColor} ${item.bgHoverColor} ${
                    item.isActive && 'border-2 outline-offset-8 border-blue-500'
