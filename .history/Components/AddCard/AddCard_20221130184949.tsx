...
const AddCard = () => {
  const { CardState, openCardForm, closeCardForm } = useContext(CardContext);
  ...
  return (
    <Fragment>
      ...
      {/* Form*/}
      {isCardFormOpen && (
        <form className='flex flex-col w-[17rem] rounded-sm bg-gray-300 p-1.5 gap-2 text-sm text-gray-500'>
          <input
            type='text'
