...
const ErrorAlert = ({ errorMsg, additionalMsg, closeAlert }: IErrorAlert) => {
  return (
    <div className='absolute p-5 mb-4 text-red-500 border border-red-300 rounded-lg shadow-md bg-gray-800 dark:bg-gray-800 dark:text-red-400 dark:border-red-900'>
