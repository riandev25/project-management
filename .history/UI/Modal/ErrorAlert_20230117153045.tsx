...
const ErrorAlert = ({ errorMsg, additionalMsg }: IErrorAlert) => {
  return (
    <div
      ...
      className='absolute top-1/2 left-1/2 p-4 mb-4 text-red-900 border border-red-300 rounded-lg bg-gray-800 dark:bg-gray-800 dark:text-red-400 dark:border-red-900'
      role='alert'
    >
