...
const ErrorAlert = ({ errorMsg, additionalMsg, closeAlert }: IErrorAlert) => {
  return (
    <div className='absolute top-1/2 right-1/2 p-5 mb-4 text-white border border-red-400 rounded-lg shadow-md bg-red-700 transition dark:bg-gray-800 dark:text-red-400 dark:border-red-900'>
