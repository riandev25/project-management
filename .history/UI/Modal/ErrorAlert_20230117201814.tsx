...
const ErrorAlert = ({ errorMsg, additionalMsg, closeAlert }: IErrorAlert) => {
  return (
    <div className='absolute p-5 mb-4 border border-red-300 rounded-lg shadow-md bg-gray-800 dark:bg-gray-800 dark:text-red-400 dark:border-red-900'>
      <div className='flex items-center text-red-300'>
        ...
        <h3 className='text-lg font-medium text-red-500'>{errorMsg}</h3>
      </div>
