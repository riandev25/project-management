...
const ErrorAlert = ({ errorMsg, additionalMsg, closeAlert }: IErrorAlert) => {
  return (
    <div className='absolute p-5 mb-4 text-white border border-red-400 rounded-lg shadow-md bg-red-700 dark:bg-gray-800 dark:text-red-400 dark:border-red-900'>
