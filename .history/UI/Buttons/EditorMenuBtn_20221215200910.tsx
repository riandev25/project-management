...
export const DualIconBtn = ({ icon1, icon2, onClick }: IDualIconBtn) => {
  return (
    <button
      type='button'
      className='px-1.5 space-x-1 rounded-sm text-gray-800 hover:bg-gray-200 focus-within:bg-red-500'
      onClick={onClick}
    >
